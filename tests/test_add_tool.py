...
class TestAddTool(TestBase):
    ...
    def test_add_multiple(self):
        with TemporaryDirectory() as tmp_dir:
            ...
            add_tool('fake_1', '123', root_repo_path=tmp_dir, refresh_index=False)  # parent only.
    ...
    #         self.make_empty_tools_map_file(temp_dir)
    #         add_tool(tool_name, tool_version, subtool_name, root_repo_path=temp_dir)
