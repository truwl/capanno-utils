...
class TestValidateInputs(TestBase):
    ...
    def test_validate_tool_inputs_1(self):
        ...
        tool_version = '8.x'
        input_hash = '8a6c'
        cwl_document_path = get_tool_sources(tool_name, tool_version)
    ...
    def test_validate_tool_inputs_2(self):
        ...
        subtool = 'flagstat'
        instance_hash = '395d'
        cwl_document_path = get_tool_sources(tool_name, tool_version, subtool_name=subtool, base_dir=self.test_content_dir)
